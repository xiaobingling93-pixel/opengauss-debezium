...
[mysql-sink.properties](https://gitcode.com/opengauss/debezium/tree/master/debezium-connector-mysql/patch/mysql-sink.properties)
...
- mysql-source.properties
  ...
  示例详见[mysql-source.properties](https://gitcode.com/opengauss/debezium/tree/master/debezium-connector-mysql/patch/mysql-source.properties)
...
- mysql-sink.properties
  ...
  示例详见[mysql-sink.properties](https://gitcode.com/opengauss/debezium/tree/master/debezium-connector-mysql/patch/mysql-sink.properties)
...
全量迁移使用[chameleon](https://gitcode.com/opengauss/openGauss-tools-chameleon)完成，可实现表，数据，函数，存储过程，视图，触发器的
离线迁移，使用指南请参考[使用指南](https://gitcode.com/opengauss/openGauss-tools-chameleon/blob/master/chameleon%E4%BD%BF%E7%94%A8%E6%8C%87%E5%8D%97.md)
...
[postgres-source.properties](https://gitcode.com/opengauss/debezium/blob/master/debezium-connector-postgres/patch/postgres-source.properties)

(3) debezium原生参数含义请参考：

[debezium原生参数](https://debezium.io/documentation/reference/1.9/connectors/postgresql.html)
...
[postgres-sink.properties](https://gitcode.com/opengauss/debezium/blob/master/debezium-connector-postgres/patch/postgres-sink.properties)
...
- postgres-source.properties
  ...
  示例详见[postgres-source.properties](https://gitcode.com/opengauss/debezium/blob/master/debezium-connector-postgres/patch/postgres-source.properties)
...
- postgres-sink.properties
  ...
  示例详见[postgres-sink.properties](https://gitcode.com/opengauss/debezium/blob/master/debezium-connector-postgres/patch/postgres-sink.properties)
...
- opengauss-source.properties
  ...
  示例详见[opengauss-source.properties](https://gitcode.com/opengauss/debezium/blob/master/debezium-connector-opengauss/patch/opengauss-source.properties)
...
- opengauss-sink.properties
  ...
  示例详见[opengauss-sink.properties](https://gitcode.com/opengauss/debezium/blob/master/debezium-connector-opengauss/patch/opengauss-sink.properties)
